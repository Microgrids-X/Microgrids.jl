...
function economics(mg::Microgrid, oper_stats::OperationStats)
    ...
    fuel_tank_cost,fuel_tank_cashflow = component_costs(mg.tanks.fuelTank, mg.project,0.0)
    h2_tank_cost ,h2_tank_cashflow = component_costs(mg.tanks.h2Tank, mg.project,oper_stats.h2_consumed-oper_stats.h2_produced)
